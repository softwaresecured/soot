...
/**
 * @ast node
 * @declaredat /home/olivier/projects/extendj/java4/grammar/Java.ast:206
 * @astdecl AssignPlusExpr : AssignAdditiveExpr;
...
public class AssignPlusExpr extends AssignAdditiveExpr implements Cloneable {
        ...
        if (dest.isString()) {
          ...
          b.add(b.newInvokeStmt(
            b.newSpecialInvokeExpr(local,
              ...
              Collections.singletonList(b.dstRead(dst)),
              this
            ), this));
          ...
          Local rightResult = b.newTemp(
            b.newVirtualInvokeExpr(local,
              stringBufferAppendMethodForType(getSource().type()).sootRef(),
              Collections.singletonList(getSource().eval(b)),
              this
            ));
  ...
  public Value createAssignOp(Body b, Value op1, Value op2) {
    Value createAssignOp_Body_Value_Value_value = b. newAddExpr(op1, op2, this);
