 ...
 * @astdecl GenericClassDecl : ClassDecl ::= Modifiers <ID:String> [SuperClass:Access] Implements:Access* BodyDecl* TypeParameter:TypeVariable*;
...
public class GenericClassDecl extends ClassDecl implements Cloneable, GenericTypeDecl {
   ...
   * @declaredat /home/olivier/projects/extendj/java5/frontend/PrettyPrintUtil.jrag:57
   */
   ...
   * @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:769
   */
...
protected ASTState.Cycle usesTypeVariable_cycle = null;
  ...
  public boolean subtype(TypeDecl type) {
    boolean subtype_TypeDecl_value = type.supertypeGenericClassDecl(this);
   ...
   * @attribute syn
   * @aspect Diamond
   * @declaredat /home/olivier/projects/extendj/java7/frontend/Diamond.jrag:137
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="Diamond", declaredAt="/home/olivier/projects/extendj/java7/frontend/Diamond.jrag:137")
  ...
  public boolean strictSubtype(TypeDecl type) {
    boolean strictSubtype_TypeDecl_value = type.strictSupertypeGenericClassDecl(this);
   ...
   * @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:676
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="GenericsTypeCheck", declaredAt="/home/olivier/projects/extendj/java5/frontend/Generics.jrag:676")
  ...
  public boolean Define_isNestedType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeParameterListNoTransform()) {
      // @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:754
  ...
  public TypeDecl Define_enclosingType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeParameterListNoTransform()) {
      // @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:755
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return this;
    }
    else {
  ...
  public SimpleSet<TypeDecl> Define_lookupType(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBodyDeclListNoTransform()) {
      // @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:818
      ...
      // @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:796
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      {
          SimpleSet<TypeDecl> result = memberTypes(name);
          result = addTypeVariables(result, name);
      ...
      // @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:791
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      {
      ...
      // @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:786
      {
          SimpleSet<TypeDecl> result = addTypeVariables(ASTNode.<TypeDecl>emptySet(), name);
          return !result.isEmpty() ? result : lookupType(name);
        }
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/olivier/projects/extendj/java5/frontend/Generics.jrag:664
