...
public class PreDecExpr extends Unary implements Cloneable {
  ...
  /**
   * @aspect Expressions
   * @declaredat /home/olivier/projects/extendj/jimple8/backend/Expressions.jrag:821
   */
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    ...
    // @declaredat /home/olivier/projects/extendj/java4/frontend/TypeCheck.jrag:423
    if (!getOperand().isVariable()) {
      {
        java.util.Set<ASTNode> contributors = _map.get(_root);
        if (contributors == null) {
    ...
    // @declaredat /home/olivier/projects/extendj/java4/frontend/TypeCheck.jrag:428
