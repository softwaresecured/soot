...
/**
 * @ast node
 * @declaredat /home/olivier/projects/extendj/java5/grammar/Generics.ast:68
...
public class WildcardSuper extends AbstractWildcard implements Cloneable {
   ...
   * @declaredat /home/olivier/projects/extendj/java5/frontend/PrettyPrint.jadd:380
   */
   ...
   * @declaredat /home/olivier/projects/extendj/java5/frontend/PrettyPrintUtil.jrag:133
   */
  ...
  /**
   * @aspect Diamond
   * @declaredat /home/olivier/projects/extendj/java7/frontend/Diamond.jrag:298
   */
  @Override
  public Access substituted(Collection<TypeVariable> original,
      List<TypeVariable> substitution) {
    return new WildcardExtends(getAccess().substituted(original, substitution));
  }
  /**
  ...
  @ASTNodeAnnotation.Source(aspect="LookupParTypeDecl", declaredAt="/home/olivier/projects/extendj/java5/frontend/Generics.jrag:1739")
