...
/**
 * @ast node
 * @declaredat /home/olivier/projects/extendj/java4/grammar/Java.ast:267
 * @astdecl GTExpr : RelationalExpr;
...
public class GTExpr extends RelationalExpr implements Cloneable {
   ...
   */
  protected ConditionExpr comparison(Body b, Value l, Value r) { return b.newGtExpr(l, r, this); }
  /**
   * @aspect BooleanExpressions
   * @declaredat /home/olivier/projects/extendj/jimple8/backend/BooleanExpressions.jrag:284
   */
  protected ConditionExpr comparisonInv(Body b, Value l, Value r) { return b.newLeExpr(l, r, this); }
  /**
