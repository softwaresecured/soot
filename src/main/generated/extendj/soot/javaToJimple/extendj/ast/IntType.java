...
public class IntType extends IntegralType implements Cloneable {
  ...
  /**
   * @aspect Expressions
   * @declaredat /home/olivier/projects/extendj/jimple8/backend/Expressions.jrag:88
   */
  public static soot.Value emitConstant(int i, Body b, ASTNode location) {
  ...
  public Type getSootType() {
    ...
    getSootType_value = soot.IntType.v();
    if (state().inCircle()) {
