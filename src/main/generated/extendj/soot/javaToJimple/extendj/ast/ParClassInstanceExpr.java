...
public class ParClassInstanceExpr extends ClassInstanceExpr implements Cloneable {
   ...
   * @declaredat /home/olivier/projects/extendj/java5/frontend/GenericMethods.jrag:288
   */
  ...
  public NameType Define_nameType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat /home/olivier/projects/extendj/java5/frontend/GenericMethods.jrag:245
  ...
  public SimpleSet<TypeDecl> Define_lookupType(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat /home/olivier/projects/extendj/java5/frontend/GenericMethods.jrag:246
      int childIndex = _callerNode.getIndexOfChild(_childNode);
