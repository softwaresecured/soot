...
/**
 * @ast node
 * @declaredat /home/olivier/projects/extendj/java4/grammar/Java.ast:142
 * @astdecl BooleanType : PrimitiveType;
...
public class BooleanType extends PrimitiveType implements Cloneable {
   ...
   * @declaredat /home/olivier/projects/extendj/java4/frontend/PrettyPrint.jadd:116
   */
  ...
  /**
   * @aspect Expressions
   * @declaredat /home/olivier/projects/extendj/jimple8/backend/Expressions.jrag:73
   */
  static IntConstant emitConstant(boolean val, Body b, ASTNode location)
  { return IntType.emitConstant(val ? 1 : 0, b, location); }
  /**
  ...
  public soot.Type sootType() {
    soot.Type sootType_value = soot.BooleanType.v();
