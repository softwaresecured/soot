...
/**
 * @ast node
 * @declaredat /home/olivier/projects/extendj/java4/grammar/Java.ast:147
 * @astdecl LongType : IntegralType;
...
public class LongType extends IntegralType implements Cloneable {
   ...
   * @declaredat /home/olivier/projects/extendj/java4/frontend/PrettyPrint.jadd:451
   */
  ...
  public soot.Type sootType() {
    soot.Type sootType_value = soot.LongType.v();
