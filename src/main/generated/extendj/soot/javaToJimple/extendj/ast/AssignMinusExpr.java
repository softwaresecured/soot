...
/**
 * @ast node
 * @declaredat /home/olivier/projects/extendj/java4/grammar/Java.ast:207
 * @astdecl AssignMinusExpr : AssignAdditiveExpr;
...
public class AssignMinusExpr extends AssignAdditiveExpr implements Cloneable {
  ...
  public Value createAssignOp(Body b, Value op1, Value op2) {
    Value createAssignOp_Body_Value_Value_value = b. newSubExpr(op1, op2, this);
