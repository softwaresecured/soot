...
public class AssignPlusExpr extends AssignAdditiveExpr implements Cloneable {
  /**
   * @aspect Expressions
   * @declaredat /home/olivier/projects/extendj/jimple8/backend/Expressions.jrag:130
   */
  public soot.Value eval(Body b) {
    TypeDecl dest = getDest().type();
    if (dest.isString()) {
      Value lvalue  = getDest().eval(b);
      Value v       = getDest().asImmediate(b, lvalue);
      ...
      Local rightResult = b.newTemp(
        b.newVirtualInvokeExpr(local,
          ...
          Collections.singletonList(getSource().asImmediate(b, getSource().eval(b))),
          this
        ));
      ...
      Value v2 = lvalue instanceof Local ? lvalue : b.setSrcLoc((Value)lvalue.clone(), lvalue);
  ...
  /**
   * @aspect Expressions
   * @declaredat /home/olivier/projects/extendj/jimple8/backend/Expressions.jrag:207
   */
