...
public class BooleanType extends PrimitiveType implements Cloneable {
  ...
  /**
   * @aspect Expressions
   * @declaredat /home/olivier/projects/extendj/jimple8/backend/Expressions.jrag:92
   */
  public static soot.Value emitConstant(boolean val, Body b, ASTNode location) {
    return b.setSrcLoc(soot.jimple.IntConstant.v(val ? 1 : 0), location);
  }
  /**
  ...
  public Type getSootType() {
    ...
    getSootType_value = soot.BooleanType.v();
    if (state().inCircle()) {
